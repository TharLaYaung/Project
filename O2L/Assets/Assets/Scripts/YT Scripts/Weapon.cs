...
public class Weapon : MonoBehaviour
{
    ...
    {
        Ray ray = playerCamera.ViewportPointToRay(new Vector3(SCREEN_CENTER, SCREEN_CENTER, 0));
        RaycastHit hit;
        ...
        if (Physics.Raycast(ray, out hit))
            ...
            targetPoint = ray.GetPoint(MAX_RAYCAST_DISTANCE);
